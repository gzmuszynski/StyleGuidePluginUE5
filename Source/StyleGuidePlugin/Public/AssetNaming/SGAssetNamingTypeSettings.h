...
struct STYLEGUIDEPLUGIN_API FSGAssetNamingTypeVariant
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct STYLEGUIDEPLUGIN_API FSGAssetNamingTypeSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct STYLEGUIDEPLUGIN_API FSGAssetNamingTypeTable
{
	GENERATED_BODY()
