...
This plugin attempts to let developers enforce customizable style guides (like the one from (UE4.Style)[ue4.style]), either through global developer settings, or on per-directory basis. 
